	...
	<div class="box bg_white pb">
	 ...
	 <div class="confirm mt">
		...
		<div class="ofc">
			<div class="r">
				<dl class="total">
					<dt>订单金额：<cite>(共<var id="totalNum">${buyCar.productAumount }</var>个商品)</cite></dt>
					<dd><em class="l">商品金额：</em>￥<var>${buyCar.productPrice }</var>元</dd>
					<dd><em class="l">返现：</em>￥<var>0.00</var>元</dd>
					<dd><em class="l">运费：</em>￥<var>${buyCar.fee }</var>元</dd>
					<dd class="orange"><em class="l">应付总额：</em>￥<var id="totalMoney">${buyCar.totalPrice }</var></dd>
