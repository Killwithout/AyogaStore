...
function buy(productId){
	window.location.href='/shopping/buyCar.shtml?skuId=' + skuId + "&amount=" + $("#num").val() + "&buyLimit=" + buyLimit + "&prpductId=" + productId;
	...
	<div class="r" style="width: 640px">
		<ul class="uls form">
			...
			<li><label>我 要 买：</label>
				...
				<input id="num" type="text" value="1" name="" size="1" readonly="readonly" style="text-align:center;">
