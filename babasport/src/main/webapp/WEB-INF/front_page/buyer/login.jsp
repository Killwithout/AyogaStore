...
<div class="sign">
	<div class="l ad420x205">
		<a href="#" title="title"><img src="/res/img/pic/ppp0.jpg" width="400" height="400"/></a>
	</div>
	<div class="r">
		<br>
		<span id="cjkTitle" title="登录新巴巴运动网">登录新巴巴运动网</span><br>
		<form id="jvForm" action="/shopping/logins.shtml" method="post">
